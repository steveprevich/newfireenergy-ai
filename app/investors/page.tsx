      ...
      <section style={{ padding: "0 24px 80px", maxWidth: 860, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            { q: "What is the investment structure?", a: "New Fire Energy issues the LENR-backed token (NFE), which backs LENR companies in their research and development. This structure provides accredited investors with direct participation in the clean energy technology ecosystem. Contact us for full details on the offering structure." },
