...
export default function NewsPage() {
  const news = [
    ...
    },
    {
      ...
      date: "Feb 2025",
      title: "ENG8 International EnergiCell Reports COP 1.8 in Independent UK Lab Test",
      body: "ENG8 International's EnergiCell device recorded a Coefficient of Performance of 1.8 in an independently verified laboratory test conducted by Dr. Robert Morgan in the UK, meaning 80% more energy output than input. The company describes the underlying mechanism as catalyzed fusion and continues advancing toward commercial prototype development.",
      source: "ENG8 International / Dr. Robert Morgan, UK, 2020",
      tag: "Breakthrough",
      color: "#22D3EE",
    },
    {
    ...
    },
    {
      ...
      body: "The U.S. Department of Energy's ARPA-E announced $10 million in federal grants to eight research institutions, including MIT, Stanford, Texas Tech, and the University of Michigan, to determine whether Low Energy Nuclear Reactions could serve as a transformative carbon-free energy source. It marked the first direct federal LENR funding in decades.",
      source: "U.S. Dept. of Energy / ARPA-E",
      tag: "Funding",
      color: "#2DD4BF",
    },
    ...
    },
    {
      ...
      body: "New Fire Energy's portfolio companies continue advancing from laboratory demonstrators toward commercial prototypes. With research studied and published by NASA, DOE, MIT, and the U.S. Navy, the fund is strategically positioned at the inflection point between scientific development and global market deployment.",
