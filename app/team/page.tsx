...
const boardMembers = [
  ...
  },
  {
    ...
    bio: "Dr. Ira Fine is a board-certified physician in Internal Medicine with over 20 years of clinical experience. He earned his M.D. from the University of North Paris and his undergraduate degree from Tulane University. He currently practices personalized medicine and maintains clinical affiliations with Delray Medical Center and Bethesda Memorial Hospital. As a member of the Board of Directors, Dr. Fine contributes a medical perspective on the broader health implications of emerging energy technologies, helping evaluate how such systems may interact with human environments over time.",
    credentials: ["Board-Certified Internal Medicine", "M.D., University of North Paris", "Tulane University", "Delray Medical Center & Bethesda Memorial Hospital"],
  },
  {
    name: "Maria Lozovaia",
            ...
            <div key={member.name} className="glass-card p-8 flex gap-6">
              <div className="shrink-0">
                <div className="relative">
                  ...
                  />
                  <div className={`absolute -inset-0.5 rounded-full bg-gradient-to-br ${member.gradient} opacity-20 blur -z-10`} />
                </div>
              </div>
                ...
                <div className="shrink-0">
                  <div className="relative">
                    <Image
                      ...
                      className="w-20 h-20 rounded-full object-cover shadow-xl"
                    />
                    <div className={`absolute -inset-0.5 rounded-full bg-gradient-to-br ${advisor.gradient} opacity-20 blur -z-10`} />
                  </div>
                </div>
                <div className="flex-1 min-w-0">
