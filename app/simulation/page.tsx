...
const COMPANY_PRESETS: CompanyPreset[] = [
  ...
  },
  {
    ...
    claim: "Catalyzed fusion · water-based · presented at Bergamo 2024",
    description: "Eng8 Energy claims catalyzed fusion, a distinct approach from ZPE or LENR. Using a proprietary catalyst in a water-based system, they aim to lower the energy barrier required for hydrogen fusion to occur, without the extreme temperatures of conventional hot fusion. They presented results at the European conference in Bergamo.",
    physics: "Eng8's process uses a catalyst dissolved in water to modify the local electromagnetic environment around hydrogen nuclei, reducing the coulomb repulsion that normally prevents fusion at low temperatures. The hydrogen in water provides the fuel. When the barrier is sufficiently lowered, fusion events produce heat. This is a different claim from lattice-phonon LENR: the catalyst chemistry, not the metal lattice, is the enabling mechanism. Independent verification of their results is ongoing.",
    params: { material: "Ti", loading: 0.73, temperature: 180, currentDensity: 470, pressure: 4, rfStimulus: 65, runTime: 90 },
    quickPrompts: ["What is catalyzed fusion?", "How does Eng8 differ from LENR?", "What role does the catalyst play in Eng8's process?", "What did Eng8 present at Bergamo?"],
  },
  {
    id: "prometeon",
    name: "Prometeon / ENEA",
    ...
    claim: "Pd-D electrolysis · ENEA Italy validated · most rigorously documented Pd-D path",
