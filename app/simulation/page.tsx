...
const COMPANY_PRESETS: CompanyPreset[] = [
  {
    ...
    verifiedCop: 1.6,
    copSource: "SRI International (Brillouin-sponsored test), 2017",
  },
  {
    id: "ecat",
    name: "Leonardo / E-Cat",
  ...
  },
  {
    ...
    description: "Clean Planet, partnered with Tohoku University's Prof. Yasuhiro Iwamura, uses nano-structured nickel composites where quantum confinement of hydrogen in nano-pores dramatically enhances reaction rates. They reported a working industrial heat demonstration in 2023, among the first reported industrial-scale LENR demonstrations globally.",
  ...
  },
  {
    ...
    location: "London, UK",
    color: "#8B5CF6",
    mechanism: "LENR · Catalyzed Fusion",
  ...
  },
  {
    ...
    color: "#EC4899",
    mechanism: "LENR · Saltwater Electrolysis Microreactor",
    keyTech: "UM microreactor · saltwater + electrical pulse · ENEA partnership · AVL tested",
    patentRef: "Certified and patented (Italy, 2025) · ENEA programme agreement",
    claim: "Saltwater LENR · heat + hydrogen output · AVL tested 2025",
    description: "Prometheus is an Italian LENR startup founded in 2021 and incubated at Kilometro Rosso in Bergamo. Their UM microreactor uses saltwater and an electrical pulse to stimulate LENR phenomena, producing heat, pressure, and hydrogen without fossil fuels or radioactive materials. In October 2025, Austrian engineering testing firm AVL List GmbH, widely known for powertrain and industrial testing, conducted independent testing of their results for repeatability, reproducibility, and scalability. Italy's national energy agency ENEA signed a partnership agreement following the testing.",
    physics: "An electrical pulse is applied to a saltwater solution, triggering low-energy nuclear events at the electrode-electrolyte boundary. The reaction produces measurable heat output, pressure, and hydrogen gas. Unlike Pd-D systems, Prometheus uses common saltwater rather than heavy water or exotic cathode materials, making the process lower cost and more scalable. AVL's certification confirmed the three industrialization benchmarks: the results repeat reliably, can be reproduced by different operators, and scale with reactor size.",
    params: { material: "Ti", loading: 0.72, temperature: 160, currentDensity: 420, pressure: 6, rfStimulus: 30, runTime: 150 },
    quickPrompts: ["How does the Prometheus UM microreactor work?", "What did AVL certify about Prometheus?", "Why is saltwater better than heavy water for LENR?", "What is Italy's ENEA doing in LENR?"],
    verifiedCop: 1.5,
    copSource: "AVL List GmbH (Austria) independent testing, October 2025",
  },
  {
    id: "safire",
    name: "Aureon / SAFIRE",
    ...
    claim: "Plasma double-layer · transmutation products confirmed by ICP-MS",
