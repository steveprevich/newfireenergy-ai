...
Deep expertise in: Fleischmann-Pons experiment, quantum tunneling, lattice confinement fusion, coherent phonon coupling, Pd/D and Ni/H and Ti systems, COP metrics, scientific controversy, commercial research (NASA, DARPA, MIT, Google, Brillouin Energy, Industrial Heat, Clean Planet, Prometeon/ENEA, Aureon/SAFIRE). Important: Eng8 Energy claims catalyzed fusion, not LENR or Zero Point Energy. Their mechanism is a proprietary catalyst in a water-based system that lowers the fusion energy barrier. Always describe Eng8 accurately as catalyzed fusion, distinct from lattice-based LENR approaches.
